# **DEVIL** TERMS OF USAGE

Last Updated: **GMT-3 30/09/2021**

These terms of service ("Terms") apply to your access and use of **x-devil.** Please read them carefully.


## Accepting these Terms

If you access or use the Service, it means you agree to be bound by all of the terms below. So, before you use the Service, please read all of the terms. If you don't agree to all of the terms below, please do not use the Service. Also, if a term does not make sense to you, please let us know by e-mailing **indusarathisan@gmail.com** or reach me via telegram **t.me/Thisan01**
...
Whenever we make changes to these Terms, the changes are effective **everytime** after we post such revised Terms (indicated by revising the date at the top of these Terms) or upon your acceptance if we provide a mechanism for your immediate acceptance of the revised Terms (such as a click-through confirmation or acceptance button). It is your responsibility to check **x-devil** for changes to these Terms.
...
There is no access to users devices or heroku accounts. Please don't give anyone your DEVIL_SESSİON and Heroku API Key. We do not accept any liability if it is shared.
...
Please let us know what you think of the Service, these Terms and, in general, **x-devil**. When you provide us with any feedback, comments or suggestions about the Service, these Terms and, in general, **x-devil**, you irrevocably assign to us all of your right, title and interest in and to your feedback, comments and suggestions.


## Questions & Contact Information

Questions or comments about the Service may be directed to us at the email address **indusarathisan@gmail.com** or reach me via telegram **t.me/Thisan01**
